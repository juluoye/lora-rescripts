...
class HunyuanImageLatentsCachingStrategy(LatentsCachingStrategy):
    ...
    def load_latents_from_disk(
        ...
        return self._default_load_latents_from_disk(32, os.fspath(cache_ref_or_path), bucket_reso)  # support multi-resolution
    ...
    def cache_batch_latents_prepared(
        self, vae: hunyuan_image_vae.HunyuanVAE2D, image_infos: List, prepared_batch, flip_aug: bool, alpha_mask: bool, random_crop: bool
    ):
