...
def prepare_diffusers_model_runtime(
    *,
    args,
    dtype,
    logger,
...
def prepare_diffusers_scheduler_runtime(
    *,
    args,
    logger,
...
def prepare_diffusers_pipeline_runtime(
    *,
    args,
    dtype,
    text_encoder,
...
def prepare_diffusers_extension_runtime(
    *,
    args,
    dtype,
    device,
    ...
    if args.opt_channels_last:
        ...
        for control_net in control_nets:
            control_net.unet.to(memory_format=torch.channels_last)
            control_net.net.to(memory_format=torch.channels_last)
