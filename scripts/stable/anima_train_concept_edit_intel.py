...
from anima_train_network_intel import _restore_missing_parser_defaults
...
from lulynx_intel.anima_lora_trainer import AnimaNetworkTrainer as BaseIntelAnimaNetworkTrainer


class AnimaConceptEditNetworkTrainer(
    anima_concept_edit_util.AnimaConceptEditTrainerMixin,
    BaseIntelAnimaNetworkTrainer,
):
    pass
