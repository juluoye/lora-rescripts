...
def build_base_metadata(
    ...
    *,
    ...
    metadata = {
        ...
        "ss_timestep_sampling": getattr(args, "timestep_sampling", "uniform"),
        "ss_timestep_sigmoid_scale": getattr(args, "timestep_sigmoid_scale", 1.0),
        "ss_timestep_shift": getattr(args, "timestep_shift", 1.0),
        "ss_timestep_loss_weighting": getattr(args, "timestep_loss_weighting", "none"),
        "ss_timestep_loss_weight_sigmoid_scale": getattr(args, "timestep_loss_weight_sigmoid_scale", 1.0),
        "ss_timestep_loss_weight_shift": getattr(args, "timestep_loss_weight_shift", 1.0),
