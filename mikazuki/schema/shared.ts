    ...
    let data = {
        ...
        RAW: {
            ...
            PRECISION_CACHE_BATCH: {
                ...
                latent_cache_disk_dtype: Schema.union(["auto", "fp16", "bf16", "fp32"]).default("auto").description("latent 磁盘缓存保存精度。auto 会尽量保留运行时 dtype；fp16 更省空间，fp32 兼容性最高。若选择 npz + bf16，会自动回退为 fp32 以确保兼容性"),
