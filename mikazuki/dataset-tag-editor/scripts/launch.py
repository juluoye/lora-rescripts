...
def prepare_environment():
    ...
    write_status("loading_interface", f"Runtime ready. Device: {devices.device}")


if __name__ == "__main__":
    try:
        prepare_environment()
        write_status("importing_interface", "Importing tag editor interface...")
        import interface
        write_status("launching_ui", "Launching Gradio UI...")
        interface.main()
