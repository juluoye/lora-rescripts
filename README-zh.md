...
- 改进 Launcher 优雅停止流程、重复点击停止保护，以及更清晰的“停止中”任务状态反馈
- 修复训练器启动失败后任务槽位被占用的问题，并改进 Windows 下的停止 / 强杀行为
- 修复 Anima、Aesthetic Scorer、Newbie 在训练、续训与 checkpoint 流程中的多项问题
- 加固社区 UI 安装流程，补充更安全的 GitHub 校验、manifest 处理与 zip 解压保护
